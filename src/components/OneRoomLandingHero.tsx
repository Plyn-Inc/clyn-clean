...
export default function OneRoomLandingHero({ offer }: { offer: OneRoomOffer | null }) {
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="mt-7"><OneRoomOfferPrice initialOffer={offer} /></div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a href="#calendar" className="inline-flex min-h-[52px] items-center rounded-full bg-[var(--navy)] px-7 text-sm font-semibold text-white">예약 가능일 확인</a>
          <a href="#booking" className="inline-flex min-h-[52px] items-center rounded-full border border-[var(--navy)] bg-white/80 px-7 text-sm font-semibold text-[var(--navy)]">빠른 견적 받기</a>
        </div>
      </div>
    </section>
  );
